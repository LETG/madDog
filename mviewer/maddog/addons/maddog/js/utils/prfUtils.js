const prfUtils = (function() {
    ...
    return {
        ...
        prfBilanSedChart: (dates) => {
            let labels;
            let selected = maddog.charts.prf.result;
            ...
            Plotly.newPlot('prfBilanSedChart', lines, {
                showlegend: false,
                title: {
                    text: `Date de référence : ${maddog.prfReference}`,
                    font: {
                        family: 'Roboto',
                        size: 16
                    },
                ...
                modeBarButtonsToAdd: [{
                    ...
                    click: function(gd) {
                        // TODO to csv export
                        //tools.downloadBlob(maddog.prfCSV, 'export.csv', 'text/csv;charset=utf-8;')
                    }
                }]
        ...
        prfPlotyChart: (dates) => {
            ...
            prfUtils.prfBilanSedChart(dates);
        },
        ...
        changePrf: () => {
            ...
            $('#prfMultiselect option:selected').each((i, el) => {
                selected.push(maddog.charts.prf.features.filter(feature => feature.properties.creationdate === $(el).val())[0]);
            });
